...
<body>
	...
	<script src="/js/admin/insertPlaceForm.js"></script>

	<%@ include file="../header.jsp" %>

	<p class="max-wd800 center">장소 추가</p>
	<hr class="max-wd800 center hr-gray">

	<form:form method="post" modelAttribute="placePostReq"
		action="/place/post" class="max-wd600 center"
		encType="multipart/form-data">

		<div class="max-wd800 center container" style="padding-left: 0px;">
			<div class="row">
				<div class="col-md-2">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<form:input type="text" class="form-control" id="address"
						path="placeDTO.address" placeholder="주소를 적어주세요" />
					<small class="col-red">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<form:input type="text" class="form-control" id="phone"
						path="placeDTO.phone" placeholder="형식: 0000-0000-0000" />
					<small class="col-red">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<form:select class="form-select" path="placeDTO.areaCode"
						id="areaCode" aria-label="Default select example">
			...
			<div class="row">
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="charge10Hrs"
						path="placeRateDTOList[0].price" value="0"/>
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="charge30Hrs"
						path="placeRateDTOList[1].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
			...
			<!-- hr width 시간부터 -->
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="charge50Hrs"
						path="placeRateDTOList[2].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="charge100Hrs"
						path="placeRateDTOList[3].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="charge150Hrs"
						path="placeRateDTOList[4].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
				...
				<div class="col-md-2 pl-0">
					...
					<form:input type="number" class="form-control" id="charge200Hrs"
						path="placeRateDTOList[5].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
			...
			<div class="row">
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="periodUnreserved1Weeks"
						path="placeRateDTOList[6].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="periodUnreserved2Weeks"
						path="placeRateDTOList[7].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
				...
				<div class="input-group" style="width: 50%;">
					...
					<form:input type="number" class="form-control" id="periodUnreserved4Weeks"
						path="placeRateDTOList[8].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
				...
				<div class="input-group" style="width: 50%;">
					<form:hidden path="placeRateDTOList[9].rateId" value="15" />
					<form:input type="number" class="form-control" id="periodReserved4Weeks"
						path="placeRateDTOList[9].price" value="0"/>
					<span class="input-group-text">원</span>
					<small class="col-red">
		...
		<div class="max-wd800 center container supply pl-0">
			...
			<div class="row">
				...
				<div class="col-md-2">
					...
					placeholder="숫자만 적어주세요" hidden="hidden"/>
				</div>
				<div class="col-md-2">
			...
			<div class="row">
				...
				<div class="col-md-2">	
					<form:input type="number" path="placeServiceDTOList[3].pricePaid"
						placeholder="1장당 가격" hidden="hidden"/>
				</div>
				<div class="col-md-2">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<form:radiobutton path="placeServiceDTOList[10].feeStatus"
						value="N/A" label="미제공" checked="checked"/>
				</div>
				<p class="col-red">
		...
		<hr class="max-wd800 center hr-6gray">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<img id="preview" class="thumbnail" src="../images/noimage.jpg"/><br>
					<input type="file" name="placeImageDTO.file" id="imageFile">
					<p class="col-red" class="fileError"></p>
				</div>				
			</div>
		</div>
		
			<div class="max-wd800 center">
				<button type="submit" class="submitBtn btn btn-outline-secondary">기본정보
					저장</button>
			</div>
	</form:form>
