...
<body>
	...
	<script src="/js/seats/reserveSeats.js"></script>
		...
		<div class="seat-image seatContainer" >
			...
			<div class="rows relative wd-50" id="move13">
			...
			<div class="rows relative wd-50" id="move19">
			...
			<div class="rows relative wd-50" id="move22">
				<div class="seat" id="39">39</div>
			</div>
			
			<div class="rows relative wd-100" id="move23">
				<div class="seat" id="40">40</div>
				<div class="seat" id="41">41</div>				
			</div>
			<div class="rows relative wd-100" id="move24">
				<div class="seat" id="42">42</div>
				<div class="seat" id="43">43</div>
			</div>
			<div class="rows relative wd-50" id="move25">
				<div class="seat" id="44">44</div>
			</div>
			
			<div class="rows relative wd-100" id="move26">
				<div class="seat" id="45">45</div>
				<div class="seat" id="46">46</div>
			</div>
			<div class="rows relative wd-100" id="move27">
				<div class="seat" id="47">47</div>
				<div class="seat" id="48">48</div>
			</div>
			<div class="rows relative wd-50" id="move28">
	...
	<div class="max-wd800 center buttons">
		<button class="reserveBtn" value="119">좌석 예약</button>
		<button class="returnBtn" value="119">좌석 반납</button>
	</div>
...
.nav {
	width: 80%;
	margin: 0 auto;
	border-bottom: 0.1px solid #F5F8F5B0;
}
