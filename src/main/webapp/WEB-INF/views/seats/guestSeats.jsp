...
<body>
	...
	<script src="/js/seats/guestSeats.js"></script>
 	
 <div class="header">
		<%@ include file="../header.jsp"%>	
		<div class="max-wd800 center h170" id="subtitle">
		<select id="newPlace" class="mt-10">
			<option value="117" selected>방이점</option>
			<option value="118">고덕점</option>
			<option value="119">잠실학원사거리점</option>
		</select>
		<h4 class="max-wd800 center">방문을 환영합니다</h4>
