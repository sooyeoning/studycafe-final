	...
	<script src="/js/place/placeList.js"></script>
		...
		<div class="maxwd-80 center" id="searchDiv">
			...
			<div class="max-wd800 center">
				<input type="checkbox" class="btn-check blanket"
					id="btn-check-2-outlined blanket" name="option" value="9">
				<label class="btn" for="btn-check-2-outlined blanket"> 
					<small>#담요</small>
				</label> 
				<input type="checkbox" class="btn-check bookstand"
					id="btn-check-2-outlined bookstand" name="option" value="10">
				<label class="btn" for="btn-check-2-outlined bookstand"> 
					<small>#독서대</small>
				</label> 
				<input type="checkbox" class="btn-check phoneCharger"
					id="btn-check-2-outlined phoneCharger" name="option" value="11">
				<label class="btn" for="btn-check-2-outlined phoneCharger"> 
					<small>#핸드폰 충전기</small>
				</label> 
				<input type="checkbox" class="btn-check lamp"
					id="btn-check-2-outlined lamp" name="option" value="12"> 
				<label class="btn" for="btn-check-2-outlined lamp"> 
						<small>#스탠드</small>
				</label> 
				<input type="checkbox" class="btn-check cushion"
					id="btn-check-2-outlined cushion" name="option" value="13">
				<label class="btn" for="btn-check-2-outlined cushion"> 
					<small>#방석</small>
				</label> 
				<input type="checkbox" class="btn-check coffee"
					id="btn-check-2-outlined coffee" name="option" value="1"> 
				<label class="btn" for="btn-check-2-outlined coffee"> 
						<small>#커피</small>
				</label> 
				<input type="checkbox" class="btn-check drinks"
					id="btn-check-2-outlined drinks" name="option" value="2"> 
				<label class="btn " for="btn-check-2-outlined drinks">
					<small>#음료</small>
				</label> 
				<input type="checkbox" class="btn-check snack"
					id="btn-check-2-outlined snack" name="option" value="3"> 
				<label class="btn " for="btn-check-2-outlined snack">
					<small>#간식</small>
				</label> 
				<input type="checkbox" class="btn-check cafeteria"
				id="btn-check-2-outlined cafeteria" name="option" value="15">
				<label class="btn" for="btn-check-2-outlined cafeteria"> 
					<small>#취식가능</small>
				</label> 
				<input type="checkbox" class="btn-check wifi"
					id="btn-check-2-outlined wifi" name="option" value="14"> 
				<label class="btn" for="btn-check-2-outlined wifi"> 
					<small>#와이파이</small>
				</label> 
				<input type="checkbox" class="btn-check seperate_restroom"
				...
				<input type="checkbox" class="btn-check locker"
					id="btn-check-2-outlined locker" name="option" value="6"> 
				<label class="btn" for="btn-check-2-outlined locker"> 
					<small>#사물함</small>
				</label> 
				<input type="checkbox" class="btn-check meetingRoom"
					id="btn-check-2-outlined meetingRoom" name="option" value="8">
				<label class="btn" for="btn-check-2-outlined meetingRoom"> 
					<small>#회의실</small>
				</label> 
				...
				id="btn-check-2-outlined printer" name="option" value="4"> 
				<label class="btn" for="btn-check-2-outlined printer"> 
					<small>#프린터</small>
				</label> 
				<input type="checkbox" class="btn-check scanner"
				id="btn-check-2-outlined scanner" name="option" value="5"> 
				<label class="btn" for="btn-check-2-outlined scanner"> 
					<small>#스캐너</small>
				</label>
			</div>
